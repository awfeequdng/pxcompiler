...
#ifndef PXC_SYNTAX_LEX_SCAN_HELPER_H_
#define PXC_SYNTAX_LEX_SCAN_HELPER_H_
...
class StringLexHelper {
 ...
 private:
  std::string str_;
  yyscan_t yyscanner_;
  pxc::ParseAndLexContext& context_;
...
auto ReadHashTags(pxc::StringLexHelper& scan_helper, size_t hashtag_num)
    -> bool;
...
auto ProcessSingleLineString(std::string str,
                             pxc::ParseAndLexContext& context,
                             size_t hashtag_num) -> pxc::Parser::symbol_type;
...
#endif  // PXC_SYNTAX_LEX_SCAN_HELPER_H_
