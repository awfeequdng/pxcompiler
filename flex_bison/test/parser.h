...
#ifndef YY_YY_TEST_PARSER_H_INCLUDED
# define YY_YY_TEST_PARSER_H_INCLUDED
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    IMPORT = 279,                  // IMPORT
    IS = 280,                      // IS
    LEFT_CURLY_BRACE = 281,        // LEFT_CURLY_BRACE
    LEFT_PARENTHESIS = 282,        // LEFT_PARENTHESIS
    ...
    PLUS = 288,                    // PLUS
    RETURN = 289,                  // RETURN
    RIGHT_CURLY_BRACE = 290,       // RIGHT_CURLY_BRACE
    RIGHT_PARENTHESIS = 291,       // RIGHT_PARENTHESIS
    RIGHT_SQUARE_BRACKET = 292,    // RIGHT_SQUARE_BRACKET
    SELF = 293,                    // SELF
    SEMICOLON = 294,               // SEMICOLON
    SLASH = 295,                   // SLASH
    STRING = 296,                  // STRING
    TRUE = 297,                    // TRUE
    UNDERSCORE = 298,              // UNDERSCORE
    WHILE = 299                    // WHILE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CLASS = 12,                            // CLASS
        S_COLON = 13,                            // COLON
        S_COLON_BANG = 14,                       // COLON_BANG
        S_COMMA = 15,                            // COMMA
        S_CONTINUE = 16,                         // CONTINUE
        S_DOUBLE_ARROW = 17,                     // DOUBLE_ARROW
        S_ELSE = 18,                             // ELSE
        S_EQUAL = 19,                            // EQUAL
        S_EQUAL_EQUAL = 20,                      // EQUAL_EQUAL
        S_FALSE = 21,                            // FALSE
        S_FOR = 22,                              // FOR
        S_IF = 23,                               // IF
        S_IMPORT = 24,                           // IMPORT
        S_IS = 25,                               // IS
        S_LEFT_CURLY_BRACE = 26,                 // LEFT_CURLY_BRACE
        S_LEFT_PARENTHESIS = 27,                 // LEFT_PARENTHESIS
        S_LEFT_SQUARE_BRACKET = 28,              // LEFT_SQUARE_BRACKET
        S_MINUS = 29,                            // MINUS
        S_NOT = 30,                              // NOT
        S_OR = 31,                               // OR
        S_PERIOD = 32,                           // PERIOD
        S_PLUS = 33,                             // PLUS
        S_RETURN = 34,                           // RETURN
        S_RIGHT_CURLY_BRACE = 35,                // RIGHT_CURLY_BRACE
        S_RIGHT_PARENTHESIS = 36,                // RIGHT_PARENTHESIS
        S_RIGHT_SQUARE_BRACKET = 37,             // RIGHT_SQUARE_BRACKET
        S_SELF = 38,                             // SELF
        S_SEMICOLON = 39,                        // SEMICOLON
        S_SLASH = 40,                            // SLASH
        S_STRING = 41,                           // STRING
        S_TRUE = 42,                             // TRUE
        S_UNDERSCORE = 43,                       // UNDERSCORE
        S_WHILE = 44,                            // WHILE
        S_YYACCEPT = 45,                         // $accept
        S_input = 46,                            // input
        S_import_directives = 47,                // import_directives
        S_import_directive = 48,                 // import_directive
        S_binding_lhs = 49                       // binding_lhs
      };
    };
...
#line 2030 "./test/parser.h"




#endif // !YY_YY_TEST_PARSER_H_INCLUDED
